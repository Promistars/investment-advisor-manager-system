...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  'share.copy_legacy': { zh: "复制兼容链接", en: "Copy legacy link" },
  'share.copy_v2': { zh: "复制 v2 链接", en: "Copy v2 link" },
