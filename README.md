...
> **"让代码处理繁琐，让大脑专注决策。"** > 这是一款专为专业投资者与独立投顾打造的**企业级前后台隔离**资产管理系统。不仅实现了毫秒级的精准记账，更融合了自动化除权息处理、双口径价格引擎与客户视角的丝滑大屏展示。

---

## ✨ 核心硬核特性 (Core Features)

### 1. 🛡️ 前后台物理隔离架构 (B/S Isolation)
...
### 2. 🧮 “时空平滑”双擎价格基准 (Dual-Engine Pricing)
...
├── app.py                  # 系统大厅与登录鉴权网关
├── pages/
│   └── analytics.py        # 📈 量化分析看板与核心撮合引擎 (Main Logic)
